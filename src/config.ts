...
export const siteConfig: SiteConfig = {
	title: "lemon-blog",
	subtitle: "One Person Blog",
	siteURL: "https://lemon-blog.site/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2024-08-15", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Gitee",
					url: "https://gitee.com/lzywantsleep",
					external: true,
					icon: "mdi:git",
				},
			],
